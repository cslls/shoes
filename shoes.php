    ...
    <div class="layout_padding gallery_section">
    	<div class="container">
    		<div class="row">
				...
				$shoes = mysqli_query($connection,"SELECT * FROM `shoes`");
				$shoes = mysqli_fetch_all($shoes);

				foreach ($shoes as $shoe) {
					$stars = '';
					for ($i=0; $i < $shoe[4]; $i++) { 
						$stars = $stars . '<li><a href="#"><img src="images/star-icon.png"></a></li>';
					}
					echo 
					'<div class="col-sm-4">
						<div class="best_shoes">
							<p class="best_text">' . $shoe[1] . '</p>
							<div class="shoes_icon"><img src="images/' . $shoe[3] . '.png"></div>
							<div class="star_text">
								<div class="left_part">
									<ul>'. 
										$stars
								...
								<div class="right_part">
									<div class="shoes_price">$ <span style="color: #ff4e5b;">' . $shoe[2] . '</span></div>
								</div>
							</div>
						</div>
					</div>';
